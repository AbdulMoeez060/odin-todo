...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  margin: 0;\n  padding: 0;\n  font-family: \"Poppins\", sans-serif;\n  --main-green: #1abc9c;\n  --second-green: #2ecc71;\n  --bgColor2: #ececec;\n  --bgColor3: #f2f3f5;\n  --bgColor1: #fefcfe;\n  --bgColorPopUp: #f3f1f3;\n  --textColor: #374958;\n  --accentDark: #1f8d4d;\n  --accent: #2abd67;\n}\nbody {\n  height: 100%;\n}\n\nheader {\n  position: relative;\n  height: 70px;\n  background-color: var(--bgColor3);\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border-bottom: 2px solid var(--accentDark);\n}\n.hamburger {\n  position: absolute;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  top: 6px;\n  left: 10px;\n  padding: 4px;\n  border-radius: 4px;\n  cursor: pointer;\n}\n.hamburger:hover,\n.project-item > img:hover {\n  background-color: rgba(128, 128, 128, 0.267);\n}\n.hamburger:active,\nbutton:active,\n.project-item > img:active,\n.project-form > .buttons > input:active {\n  transform: scale(0.9);\n}\n.logo {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 30px;\n  font-weight: 600;\n  gap: 8px;\n  cursor: pointer;\n}\n.logo > span {\n  color: var(--second-green);\n}\n\n.container {\n  display: flex;\n  position: relative;\n  box-sizing: border-box;\n  height: 100%;\n}\n.sidebar {\n  background-color: var(--bgColor1);\n  box-sizing: border-box;\n  width: 350px;\n  user-select: none;\n  display: flex;\n  flex-direction: column;\n  padding: 20px;\n  gap: 15px;\n  transition: 1.5s ease-in;\n}\n\n.home,\n.projects {\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n}\n.sidebar button,\n.project-item {\n  display: flex;\n  justify-content: start;\n  height: 40px;\n  gap: 15px;\n  align-items: center;\n  font-size: 18px;\n  padding-left: 10px;\n  outline: none;\n  border: none;\n  background-color: transparent;\n}\n.sidebar button:hover,\n.project-form:hover,\n.project-item:hover {\n  border-radius: 5px;\n  background-color: var(--bgColor2);\n}\n.home > button.active {\n  border-radius: 0 5px 5px 0;\n  border-left: 5px solid var(--accent);\n  background-color: #2abd6770;\n}\n.home > button.active:hover,\n.project-form > .buttons > input:hover {\n  filter: brightness(90%) !important;\n}\n\n.sidebar h2 {\n  border-bottom: 1px solid black;\n  padding-bottom: 5px;\n  padding-left: 5px;\n  font-weight: 600;\n}\n\n.hide {\n  top: 0;\n  left: 0;\n  pointer-events: none !important;\n  position: absolute !important;\n  max-height: 0 !important;\n  transition: max-height 1s ease-out !important;\n  opacity: 0 !important;\n}\n\n.add-project{\n  transition: 1s ease-out;\n\n}\n\n.project-item {\n  justify-content: space-between;\n}\n.project-item > img {\n  padding: 3px;\n  border-radius: 4px;\n  margin-right: 5px;\n}\n\n.project-form {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding-top: 10px;\n  padding-bottom: 10px;\n  transition: .5s ease-in-out;\n  gap: 15px;\n}\n.project-form > input[type=\"text\"] {\n  width: 80%;\n  height: 30px;\n  border: black 2px solid;\n  border-radius: 2px;\n  padding-left: 5px;\n}\n.project-form > .buttons {\n  display: flex;\n  gap: 10px;\n}\n.project-form > .buttons > input {\n  border: none;\n  width: 70px;\n  color: white;\n  font-size: 16px;\n  height: 35px;\n  border-radius: 4px;\n}\n.project-form > .buttons > input[value=\"Add\"] {\n  background-color: var(--accentDark);\n}\n.project-form > .buttons > input[value=\"Cancel\"] {\n  background-color: rgb(235, 80, 80);\n}\n\n.content {\n  background-color: var(--bgColor2);\n  padding: 30px 50px;\n  flex: 1;\n  min-height: 100vh;\n  box-sizing: border-box;\n  display: flex;\n  flex-direction: column;\n}\n.name{\n  background-color: var(--accent);\n    height: 60px;\n    padding: 20px;\n    font-size: 2rem;\n    color: #f7f5f5;\n    border-radius: 3px;\n    margin-bottom: 10px;\n}\n@media (max-width: 930px) {\n  .container {\n    flex-direction: column;\n  }\n  .sidebar {\n    z-index: 3;\n    overflow: auto;\n    width: auto;\n  }\n}\n", "",{"version":3,"sources":["webpack://./src/styles/main.css"],"names":[],"mappings":"AACA;EACE,SAAS;EACT,UAAU;EACV,kCAAkC;EAClC,qBAAqB;EACrB,uBAAuB;EACvB,mBAAmB;EACnB,mBAAmB;EACnB,mBAAmB;EACnB,uBAAuB;EACvB,oBAAoB;EACpB,qBAAqB;EACrB,iBAAiB;AACnB;AACA;EACE,YAAY;AACd;;AAEA;EACE,kBAAkB;EAClB,YAAY;EACZ,iCAAiC;EACjC,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,0CAA0C;AAC5C;AACA;EACE,kBAAkB;EAClB,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,QAAQ;EACR,UAAU;EACV,YAAY;EACZ,kBAAkB;EAClB,eAAe;AACjB;AACA;;EAEE,4CAA4C;AAC9C;AACA;;;;EAIE,qBAAqB;AACvB;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,eAAe;EACf,gBAAgB;EAChB,QAAQ;EACR,eAAe;AACjB;AACA;EACE,0BAA0B;AAC5B;;AAEA;EACE,aAAa;EACb,kBAAkB;EAClB,sBAAsB;EACtB,YAAY;AACd;AACA;EACE,iCAAiC;EACjC,sBAAsB;EACtB,YAAY;EACZ,iBAAiB;EACjB,aAAa;EACb,sBAAsB;EACtB,aAAa;EACb,SAAS;EACT,wBAAwB;AAC1B;;AAEA;;EAEE,aAAa;EACb,sBAAsB;EACtB,SAAS;AACX;AACA;;EAEE,aAAa;EACb,sBAAsB;EACtB,YAAY;EACZ,SAAS;EACT,mBAAmB;EACnB,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,YAAY;EACZ,6BAA6B;AAC/B;AACA;;;EAGE,kBAAkB;EAClB,iCAAiC;AACnC;AACA;EACE,0BAA0B;EAC1B,oCAAoC;EACpC,2BAA2B;AAC7B;AACA;;EAEE,kCAAkC;AACpC;;AAEA;EACE,8BAA8B;EAC9B,mBAAmB;EACnB,iBAAiB;EACjB,gBAAgB;AAClB;;AAEA;EACE,MAAM;EACN,OAAO;EACP,+BAA+B;EAC/B,6BAA6B;EAC7B,wBAAwB;EACxB,6CAA6C;EAC7C,qBAAqB;AACvB;;AAEA;EACE,uBAAuB;;AAEzB;;AAEA;EACE,8BAA8B;AAChC;AACA;EACE,YAAY;EACZ,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,uBAAuB;EACvB,iBAAiB;EACjB,oBAAoB;EACpB,2BAA2B;EAC3B,SAAS;AACX;AACA;EACE,UAAU;EACV,YAAY;EACZ,uBAAuB;EACvB,kBAAkB;EAClB,iBAAiB;AACnB;AACA;EACE,aAAa;EACb,SAAS;AACX;AACA;EACE,YAAY;EACZ,WAAW;EACX,YAAY;EACZ,eAAe;EACf,YAAY;EACZ,kBAAkB;AACpB;AACA;EACE,mCAAmC;AACrC;AACA;EACE,kCAAkC;AACpC;;AAEA;EACE,iCAAiC;EACjC,kBAAkB;EAClB,OAAO;EACP,iBAAiB;EACjB,sBAAsB;EACtB,aAAa;EACb,sBAAsB;AACxB;AACA;EACE,+BAA+B;IAC7B,YAAY;IACZ,aAAa;IACb,eAAe;IACf,cAAc;IACd,kBAAkB;IAClB,mBAAmB;AACvB;AACA;EACE;IACE,sBAAsB;EACxB;EACA;IACE,UAAU;IACV,cAAc;IACd,WAAW;EACb;AACF","sourcesContent":["@import url(\"https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400;500;600;700&family=Kristi&family=Poppins:wght@300;400;500;600;700;800&family=Roboto:ital,wght@0,400;0,700;0,900;1,500&display=swap\");\n* {\n  margin: 0;\n  padding: 0;\n  font-family: \"Poppins\", sans-serif;\n  --main-green: #1abc9c;\n  --second-green: #2ecc71;\n  --bgColor2: #ececec;\n  --bgColor3: #f2f3f5;\n  --bgColor1: #fefcfe;\n  --bgColorPopUp: #f3f1f3;\n  --textColor: #374958;\n  --accentDark: #1f8d4d;\n  --accent: #2abd67;\n}\nbody {\n  height: 100%;\n}\n\nheader {\n  position: relative;\n  height: 70px;\n  background-color: var(--bgColor3);\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border-bottom: 2px solid var(--accentDark);\n}\n.hamburger {\n  position: absolute;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  top: 6px;\n  left: 10px;\n  padding: 4px;\n  border-radius: 4px;\n  cursor: pointer;\n}\n.hamburger:hover,\n.project-item > img:hover {\n  background-color: rgba(128, 128, 128, 0.267);\n}\n.hamburger:active,\nbutton:active,\n.project-item > img:active,\n.project-form > .buttons > input:active {\n  transform: scale(0.9);\n}\n.logo {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 30px;\n  font-weight: 600;\n  gap: 8px;\n  cursor: pointer;\n}\n.logo > span {\n  color: var(--second-green);\n}\n\n.container {\n  display: flex;\n  position: relative;\n  box-sizing: border-box;\n  height: 100%;\n}\n.sidebar {\n  background-color: var(--bgColor1);\n  box-sizing: border-box;\n  width: 350px;\n  user-select: none;\n  display: flex;\n  flex-direction: column;\n  padding: 20px;\n  gap: 15px;\n  transition: 1.5s ease-in;\n}\n\n.home,\n.projects {\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n}\n.sidebar button,\n.project-item {\n  display: flex;\n  justify-content: start;\n  height: 40px;\n  gap: 15px;\n  align-items: center;\n  font-size: 18px;\n  padding-left: 10px;\n  outline: none;\n  border: none;\n  background-color: transparent;\n}\n.sidebar button:hover,\n.project-form:hover,\n.project-item:hover {\n  border-radius: 5px;\n  background-color: var(--bgColor2);\n}\n.home > button.active {\n  border-radius: 0 5px 5px 0;\n  border-left: 5px solid var(--accent);\n  background-color: #2abd6770;\n}\n.home > button.active:hover,\n.project-form > .buttons > input:hover {\n  filter: brightness(90%) !important;\n}\n\n.sidebar h2 {\n  border-bottom: 1px solid black;\n  padding-bottom: 5px;\n  padding-left: 5px;\n  font-weight: 600;\n}\n\n.hide {\n  top: 0;\n  left: 0;\n  pointer-events: none !important;\n  position: absolute !important;\n  max-height: 0 !important;\n  transition: max-height 1s ease-out !important;\n  opacity: 0 !important;\n}\n\n.add-project{\n  transition: 1s ease-out;\n\n}\n\n.project-item {\n  justify-content: space-between;\n}\n.project-item > img {\n  padding: 3px;\n  border-radius: 4px;\n  margin-right: 5px;\n}\n\n.project-form {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding-top: 10px;\n  padding-bottom: 10px;\n  transition: .5s ease-in-out;\n  gap: 15px;\n}\n.project-form > input[type=\"text\"] {\n  width: 80%;\n  height: 30px;\n  border: black 2px solid;\n  border-radius: 2px;\n  padding-left: 5px;\n}\n.project-form > .buttons {\n  display: flex;\n  gap: 10px;\n}\n.project-form > .buttons > input {\n  border: none;\n  width: 70px;\n  color: white;\n  font-size: 16px;\n  height: 35px;\n  border-radius: 4px;\n}\n.project-form > .buttons > input[value=\"Add\"] {\n  background-color: var(--accentDark);\n}\n.project-form > .buttons > input[value=\"Cancel\"] {\n  background-color: rgb(235, 80, 80);\n}\n\n.content {\n  background-color: var(--bgColor2);\n  padding: 30px 50px;\n  flex: 1;\n  min-height: 100vh;\n  box-sizing: border-box;\n  display: flex;\n  flex-direction: column;\n}\n.name{\n  background-color: var(--accent);\n    height: 60px;\n    padding: 20px;\n    font-size: 2rem;\n    color: #f7f5f5;\n    border-radius: 3px;\n    margin-bottom: 10px;\n}\n@media (max-width: 930px) {\n  .container {\n    flex-direction: column;\n  }\n  .sidebar {\n    z-index: 3;\n    overflow: auto;\n    width: auto;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ })()
;
//# sourceMappingURL=bundlea780445ca33a8d213ff9.js.map